...
### Abstract
We are interested in anticipating as early as possible the target location of some-1one’s object manipulation action in a 3D workspace from egocentric vision. It is2important in fields like human-robot collaboration, but has not yet received enough3attention from vision and learning communities.  To stimulate more research on4this challenging egocentric vision task, we propose a large multi-modal dataset of5more than 1 million frames of RGBD and IMU streams, and provide evaluation6metrics based on our high-quality 2D and 3D labels from semi-automatic anno-7tation. Meanwhile, we design baseline methods using recurrent neural networks8(RNNs) and conduct various ablation studies to validate their effectiveness. Our9results demonstrate that this new task is worthy of further study and could attract10researchers in robotics, vision, and learning.
