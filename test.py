...
from data_utils.testDataLoader import testttDataLoader
import datetime
import logging
...
def parse_args():
    '''PARAMETERS'''
    parser = argparse.ArgumentParser('Predictor baseline test')
...
def main(args):
    ...
    TEST_DATASET = testttDataLoader(root=DATA_PATH,num=args.num_point)
